...
namespace MyPo.Shared.Api.Controller;
...
public abstract class ApiBaseController : ControllerBase
{
	...
	/// </summary>
	/// <returns></returns>
	protected async Task<MyPoUser?> GetCurrentUserAsync(IdentityOptions identityOptions, IIdentityRepository identityRepository)
	{
