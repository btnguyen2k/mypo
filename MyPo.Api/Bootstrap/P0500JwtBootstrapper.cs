...
/// <summary>
/// Built-in bootstrapper that initializes JWT configurations and services.
/// </summary>
/// <remarks>
///		- This bootstrapper requires access to the RSA private key. Hence, it should be initialized after the <see cref="CryptoKeysBootstrapper"/>.<br/>
///		- This bootstrapper stores the JWT configurations in the service container as IOption&lt;<see cref="JwtOptions"/>&gt; for later use via dependency injection.<br/>
///		- Also, a <see cref="IJwtService"/> is registered in the service container.
/// </remarks>
