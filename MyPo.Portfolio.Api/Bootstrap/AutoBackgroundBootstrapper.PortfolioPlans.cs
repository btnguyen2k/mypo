...
sealed class AutoBackgroundPortfolioPlansScanner : AutoBackgroundAnnouncementScanner
{
    public AutoBackgroundPortfolioPlansScanner(
                ...
                try
                {
                    ...
                    foreach (var user in allUsers)
                        try
                        {
                            ...
                            Logger.LogInformation("Processing portfolio plan alerts for user {userId}...", userId);
                            ...
                            var alertDelay = TimeSpan.FromDays(prefs.AutoAnalyzeDays);
