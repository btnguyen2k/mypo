...
public partial class CPortfolioTxBuysSells : CBase
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        if (firstRender && Transactions is not null && Markets is not null && Portfolio is not null)
        {
            ...
            _ = Task.Run(async() => {
                ...
                await jsDatetimePicker.InvokeAsync<object>("InitDatetimePickers");
            });
            ...
            _ = Task.Run(async() => {
                ...
                await jsDatatable.InvokeAsync<object>("MakeDatatable", "#tblTxBuysSells");
            });
        }
    }
